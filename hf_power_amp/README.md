...
| 30, 40 | 7 - 10.15 | 14 | 6 | 680 pF, 870 nH, 970 pF, 920 nH, 970 pF, 870 nH, 680 pF |
...
Plan is to use 2 strips of alimunim foil with a strip of trash bag material all folded into a zig-zag shape. The foil will be doubled up but better then rolling which will cause high inductance.

Example with calculation: 3 cm wide by 10 cm per foil "plate" gives 30 cm^3. say using medium